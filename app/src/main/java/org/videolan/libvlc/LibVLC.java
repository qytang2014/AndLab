...
public class LibVLC {
    ...
    public static synchronized void restart(Context context) {
        if (sInstance != null) {
            try {
                ...
                Log.e(TAG, "Unable to reinit org.videolan.libvlc: " + lve);
            }
        }
    }
    ...
    public void playMRL(String mrl) {
        // index=-1 will return options from org.videolan.libvlc instance without relying on MediaList
    ...
    /**
     * Initialize the org.videolan.libvlc C library
     * @return a pointer to the org.videolan.libvlc instance
     */
    private native void nativeInit() throws LibVlcException;

    /**
     * Close the org.videolan.libvlc C library
